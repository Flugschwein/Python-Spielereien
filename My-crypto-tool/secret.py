...
def menu():
    ...
    while True:
        while choice not in choices:
            ...
            print('1. Generate OTPs.')
            print('2. Encrypt a message.')
            print('3. Decrypt a message.')
            print('4. Quit.')
            choice = input('Please type 1, 2, 3, or 4 and press Enter.')
            if choice == '1':
                sheets = int(input('How many OTPs would you like to generate?'))
                length = int(input('What is the maximum message length?'))
                ...
                filename = input('Type in the name of the encrypted file.')
